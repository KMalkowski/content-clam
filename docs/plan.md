...
- Keep videos from subscribed channels visible by default. Subscriptions are read from the sidebar, the Subscriptions feed, and the Channels page and kept on the device.
