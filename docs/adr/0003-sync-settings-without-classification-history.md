...
The extension keeps its sync choice and last-uploaded snapshot per account, so switching accounts in the same browser asks the conflict question again and never uploads one account's settings under another.
